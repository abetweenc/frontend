            ...
            cards.map((card: any, index: number) => {
              ...
              return (
                <div
                  ...
                  className="bg-white border border-[#98A0AA] shadow-[0_2px_10px_rgba(0,0,0,0.03)] py-8 px-5 lg:px-7 flex flex-col items-center text-center w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.5rem)] rounded-[2px]"
                >
                  {iconUrl && (
