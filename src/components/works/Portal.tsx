export default function Portal({ data }: any) {
  ...
  return (
    <div className="w-full bg-white py-16 px-6 lg:py-24">
      <div className="max-w-7xl mx-auto bg-[#F4F5F6] rounded-xl py-16 px-6 lg:py-20 lg:px-12 flex flex-col items-center text-center">
        {/* Pill Tag */}
        {tag && (
        ...
        {/* Heading */}
        <h2 className="font-playfair text-3xl lg:text-5xl text-[#111111] mb-6">
